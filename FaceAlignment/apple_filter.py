...
image_fruit = cv2.imread("apple.jpg")
...
def zoom(image, fix_image_fruit, point):
    for pred in fa.get_landmarks(image, boxes):  
        ...
        black_mask_big = cv2.resize(black_mask, (0, 0), fx=2, fy=2)
        mask_big = cv2.resize(mask, (0, 0), fx=2, fy=2)  
...
cv2.imwrite("output/result_lip_eyes_fruit.jpg", result)
cv2.waitKey() 